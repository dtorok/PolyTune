void initGui() {
  ...
  radioWindow.add("RECTANGULAR", Window.RECTANGULAR);
    ...
    controlP5.Label l1 = togglePCP.getCaptionLabel();
    l1.getStyle().marginLeft = 15;
    l1.getStyle().marginTop = -15;
    
    toggleLinearEQ = controlP5.addToggle("toggleLinearEQ", LINEAR_EQ_TOGGLE, 400,height-80, 10,10);
    toggleLinearEQ.setLabel("Linear EQ");
    controlP5.Label l2 = toggleLinearEQ.getCaptionLabel();
    l2.getStyle().marginLeft = 15;
    l2.getStyle().marginTop = -15;
    ...
    controlP5.Label l3 = toggleHarmonics.getCaptionLabel();
    l3.getStyle().marginLeft = 15;
    l3.getStyle().marginTop = -15;
